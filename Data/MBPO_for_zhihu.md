...
<img src="https://www.zhihu.com/equation?tex=\left|\eta[\pi]-\eta^{\pi_{D},\pi}\right|\leq2r_{\mathrm{max}}\left[\frac{\gamma^{k+1}}{(1-\gamma)^{2}}\epsilon_{\pi}+\frac{\gamma^{k}}{1-\gamma}\epsilon_{\pi}\right] 
